...
Source: [`packages/identity/cohub-account/src/index.ts:56`](../packages/identity/cohub-account/src/index.ts)

<a id="deepseek-aidsh-cohub-board"></a>

## `@deepseek-ai/dsh-cohub-board`

Requires: `cohubAccount`
...
Source: [`packages/host/cohub-board/src/index.ts:23`](../packages/host/cohub-board/src/index.ts)

<a id="deepseek-aidsh-cohub-generation"></a>

## `@deepseek-ai/dsh-cohub-generation`

Requires: `tools` · `systemPrompt` · `cohubAccount`
...
Source: [`packages/generation/cohub-generation/src/index.ts:39`](../packages/generation/cohub-generation/src/index.ts)

<a id="deepseek-aidsh-cohub-spaces"></a>

## `@deepseek-ai/dsh-cohub-spaces`

Requires: `cohubAccount` · `agents`
...
Source: [`packages/host/cohub-spaces/src/index.ts:34`](../packages/host/cohub-spaces/src/index.ts)
...
Source: [`packages/llm/llm-cohub/src/index.ts:32`](../packages/llm/llm-cohub/src/index.ts)
