...
<a id="deepseek-aidsh-cohub-account"></a>
...
来源：[`packages/identity/cohub-account/src/index.ts:56`](../packages/identity/cohub-account/src/index.ts)

<a id="deepseek-aidsh-cohub-board"></a>

## `@deepseek-ai/dsh-cohub-board`
...
来源：[`packages/host/cohub-board/src/index.ts:23`](../packages/host/cohub-board/src/index.ts)

<a id="deepseek-aidsh-cohub-generation"></a>

## `@deepseek-ai/dsh-cohub-generation`

需要：`tools` · `systemPrompt` · `cohubAccount`
...
来源：[`packages/generation/cohub-generation/src/index.ts:39`](../packages/generation/cohub-generation/src/index.ts)

<a id="deepseek-aidsh-cohub-spaces"></a>

## `@deepseek-ai/dsh-cohub-spaces`

需要：`cohubAccount` · `agents`
...
来源：[`packages/host/cohub-spaces/src/index.ts:40`](../packages/host/cohub-spaces/src/index.ts)
...
<a id="deepseek-aidsh-llm-cohub"></a>
...
来源：[`packages/llm/llm-cohub/src/index.ts:32`](../packages/llm/llm-cohub/src/index.ts)
...
- `@deepseek-ai/dsh-client-cohub-account`（[`packages/client/ui-cohub-account/src/index.ts`](../packages/client/ui-cohub-account/src/index.ts)）
- `@deepseek-ai/dsh-client-cohub-board`（[`packages/client/ui-cohub-board/src/index.ts`](../packages/client/ui-cohub-board/src/index.ts)）
- `@deepseek-ai/dsh-client-cohub-spaces`（[`packages/client/cohub-spaces/src/index.ts`](../packages/client/cohub-spaces/src/index.ts)）
...
- `@deepseek-ai/dsh-client-remote-roots`（[`packages/client/remote-roots/src/index.ts`](../packages/client/remote-roots/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-remote-roots`（[`packages/client/ui-remote-roots/src/index.ts`](../packages/client/ui-remote-roots/src/index.ts)）
