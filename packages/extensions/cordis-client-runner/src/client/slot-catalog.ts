...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.remote',
    kind: 'single',
    scope: 'root',
    summary: 'Root-scoped conversation surface takeover.',
    doc: 'Root-scoped conversation surface takeover. Remote providers use this\nseat to replace the local session body without leaving the native DSH\nconversation column or opening a modal drawer.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-remote-roots RemoteConversationOverlay',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.remote\', () => ctx.slots.register(\n      { name: \'conversation.remote\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:67',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:91',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-cohub-account AccountOverlay id \'cohub-account\'',
      'client-cohub-board BoardOverlay id \'cohub-board\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-cohub-account AccountFooterAction id \'cohub-account\'',
      'client-cohub-board BoardFooterAction id \'cohub-board\'',
  ...
  {
    key: 'sidebar.workspaces.remoteRoots',
    kind: 'single',
    scope: 'root',
    summary: 'Provider-neutral remote roots shown beside, filtered by the owner\'s Workspace query.',
    doc: 'Provider-neutral remote roots shown beside, filtered by the owner\'s Workspace query.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-remote-roots RemoteRootTree',
    ],
    replaceRisk: 'shadows-shipped-ui',
