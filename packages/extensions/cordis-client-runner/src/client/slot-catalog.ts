...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-remote-roots RemoteConversationOverlay id \'remote-conversation\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Provider-neutral remote roots shown beside, but never adopted as, local Workspaces.',
    doc: 'Provider-neutral remote roots shown beside, but never adopted as, local Workspaces.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
