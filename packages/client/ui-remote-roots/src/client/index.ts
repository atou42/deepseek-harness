...
export function apply(ctx: ClientContext): void {
  ...
  ctx.slots.inject('conversation.remote', () => ctx.slots.register(
    {
      name: 'conversation.remote', locale: NS,
      inject: (): RemoteConversationOverlayInjected => ({
        ...
        listConversationModels: (sourceId, request) => ctx.remoteRoots.listConversationModels(sourceId, request),
