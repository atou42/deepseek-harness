...
export const zh = {
  ...
  'workspace.add': '添加工作区',
  'search.workspaces.aria': '搜索工作区',
  'search.placeholder': '搜索工作区…',
  'search.clear': '清除搜索',
  'search.results.aria': '工作区搜索结果',
  'search.pending': '正在加载工作区…',
  'search.unavailable': '工作区搜索暂不可用。',
  'search.noMatches': '无匹配工作区',
  'search.hasMore': '请缩小搜索范围。',
  'menu.addWorkspace': '添加本地工作区…',
  'picker.loading': '正在加载工作区…',
  'picker.search.aria': '搜索工作区',
  'picker.search.placeholder': '搜索本地或 Cohub 工作区…',
  'picker.search.empty': '没有匹配的工作区',
  'picker.location.cloud': '云端',
...
export const en = {
  ...
  'search.workspaces.aria': 'Search workspaces',
  'search.placeholder': 'Search workspaces...',
  'search.clear': 'Clear search',
  'search.results.aria': 'Workspace search results',
  'search.pending': 'Loading workspaces…',
  'search.unavailable': 'Workspace search is unavailable.',
  'search.noMatches': 'No matching workspaces',
  'search.hasMore': 'Narrow your search.',
  'menu.addWorkspace': 'Add local workspace…',
  'picker.loading': 'Loading workspaces…',
  'picker.search.aria': 'Search workspaces',
  'picker.search.placeholder': 'Search local or Cohub workspaces…',
  'picker.search.empty': 'No matching workspaces',
  'picker.location.cloud': 'Cloud',
