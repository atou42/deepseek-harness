...
export interface ISessions {
  ...
  /**
   * Create one ordinary Host-backed DSH Session and publish it into the list before resolving.
   * @param opts - optional Workspace, cwd, or preallocated Session identity.
