...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  cohubAccount: 'extensions.md',
  cohubBoard: 'extensions.md',
  cohubSpaces: 'extensions.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  remoteRoots: 'client-side provider-neutral remote-root registry — packages/client/remote-roots/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CohubAccountSnapshot: 'Cohub account state is owned by packages/identity/cohub-account/README.md',
  CohubRemoteLogoutResult: 'Cohub browser logout result is owned by packages/identity/cohub-account/README.md',
  CohubDeviceAuthorization: 'Cohub device authorization is owned by packages/identity/cohub-account/README.md',
  CohubLoginPollResult: 'Cohub login polling is owned by packages/identity/cohub-account/README.md',
  CohubLogoutResult: 'Cohub Host logout result is owned by packages/identity/cohub-account/README.md',
  CohubBoardSnapshot: 'Cohub Board data is owned by packages/host/cohub-board/README.md',
  ...
  CohubModelCatalog: 'Cohub model data is owned by packages/host/cohub-spaces/README.md',
  CohubPromptSelection: 'Cohub prompt selection is owned by packages/host/cohub-spaces/README.md',
  ...
  CohubSpaceTextFile: 'Cohub Space text reads are owned by packages/host/cohub-spaces/README.md',
  CohubSpaceWriteResult: 'Cohub Space text writes are owned by packages/host/cohub-spaces/README.md',
