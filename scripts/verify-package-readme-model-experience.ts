...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-remote-roots': { kind: 'none', reason: 'Browser-side remote-tree presentation; registers nothing model-facing.' },
  ...
  'packages/host/cohub-spaces': { kind: 'none', reason: 'Host-side Cohub data adapter; registers nothing model-facing.' },
  'packages/host/cohub-board': { kind: 'none', reason: 'Read-only Host Board transport; registers no tool, prompt, or model context.' },
  ...
  'packages/identity/cohub-account': { kind: 'none', reason: 'The Host-side account owner exposes credentials only to adapters and registers nothing model-facing.' },
